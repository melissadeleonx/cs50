...
float discount(float regular, int percent_off) // wondering where is the in percentage declaration??
{
    return regular * (100 - percent_off / 100); // I am not sure why Prof. David did not see the bug or why the system made it work but he declared 2 different int, one int percentage and one is int percent_off: I have no idea!
