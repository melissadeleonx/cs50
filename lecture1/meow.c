...
int main(void)
{
    ...
    {
        printf("meow\n");
        i += 2; // to increment from 0 and up, syntatic sugar if you want to implement how many times you want to repeat depending on the boolean function inside while
    }
}